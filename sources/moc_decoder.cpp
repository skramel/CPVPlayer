...
**
** Created: Tue Sep 18 15:34:56 2012
...
static const char qt_meta_stringdata_Decoder[] = {
    "Decoder\0"
};
...
const QMetaObjectExtraData Decoder::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Decoder::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Decoder,
      qt_meta_data_Decoder, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Decoder::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Decoder))
